...
public class AddEmployeeSteps extends CommonMethods {
    ...
    public void user_is_able_to_see_employee_added_successfully() {
        ...
        String query = "select emp_firstname,emp_lastname from hs_hr_employee where employee_id=" + employeeIDFE;
        List<Map<String, String>> data = DBUtils.fetch(query);
        String firstNameFB = data.get(0).get("emp_firstname");
        String lastNameFB = data.get(0).get("emp_lastname");
